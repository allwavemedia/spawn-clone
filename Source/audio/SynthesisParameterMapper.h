//==============================================================================
/*
  SynthesisParam        int preferredWavetableIndex = 0;
        AdvancedSynthesisEngine::FilterParams::FilterType preferredFilterType = AdvancedSynthesisEngine::FilterParams::LowPass;
        int preferredLfoWaveform = 1; // 0=Sine, 1=Triangle, 2=Sawtooth, 3=Square, 4=RandomrMapper_Fixed.h
...
private:
    ...
    struct StyleCharacteristics
    {
        ...
        AdvancedSynthesisEngine::FilterParams::Type preferredFilterType = AdvancedSynthesisEngine::FilterParams::LowPass;
        int preferredLfoWaveform = 1; // 0=Sine, 1=Triangle, 2=Sawtooth, 3=Square, 4=Random
